...
sss_n <- length(samplelist)
	...
	text(mid, 1.5+0.2, tmparr[1], cex=1.8)
	lines(c(target_st, mid), c(1.5, 1.5-0.1), lwd=1)
	lines(c(mid, target_en), c(1.5-0.1, 1.5), lwd=1)
	text((target_en+target_st)/2, 1.5-0.1, tmparr[2], cex=1.8)
	...
	#ii=1-index+2
	mid <- (target_en+target_st)/2
	#lines(c(target_st, target_en), c(1.8, 1.8), lty=3)
	#lines(c(target_st, target_st), c(1.5, 1.5+0.2), lwd=1)
	#lines(c(target_en, target_en), c(1.5, 1.5+0.2), lwd=1)
	text(mid, 0.5+0.2, tmparr[1], cex=1.8)
	...
	text((target_en+target_st)/2, 0.5-0.1, tmparr[2], cex=1.8)
