...
if(is.element('PF00916', exon_type_uniq))
{
legend1 <- c(legend1, 'Sulfate transporter family')
legend2 <- c(legend2, 15)
legend3 <- c(legend3, "purple")
}
if(is.element('PF01740', exon_type_uniq))
{
legend1 <- c(legend1, 'STAS domain')
legend2 <- c(legend2, 15)
